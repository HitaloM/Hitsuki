...
Example:
Sometimes, you promote or demote an admin manually, and Hitsuki doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
