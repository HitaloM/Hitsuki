...
async def mute_user_cmd(message, chat, user, args, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings['mute_hitsuki'])
        return
...
async def unmute_user_cmd(message, chat, user, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings['unmute_hitsuki'])
        return
...
async def ban_user_cmd(message, chat, user, args, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings['ban_hitsuki'])
        return
...
async def unban_user_cmd(message, chat, user, strings):
    ...
    if user_id == BOT_ID:
        await message.reply(strings['unban_hitsuki'])
        return
